...
import { insertResearchStudy, updateResearchStudy, removeResearchStudyById } from '../../../api/researchStudy/methods';
...
export default class ResearchStudyDetail extends React.Component {
  getMeteorData() {
    ...
    if (Session.get('selectedResearchStudy')) {
      ...
      let selectedResearchStudy = ResearchStudy.findOne({_id: Session.get('selectedResearchStudy')});
